...
class CloudStorageApplicationTests {
   ...
   * and Deleting a note.
   *
   * Also present is the utility method to re-direct back to the notes tab after the successful testing
   */
  ...
  public void create_note() throws InterruptedException {
    ...
    webDriverWait.until(visibilityOfElementLocated(By.id("note-title"))).sendKeys("test-note-title");
    webDriverWait.until(visibilityOfElementLocated(By.id("note-description"))).sendKeys("test-note-description");
